...
public class GroupAdmin implements Sender{
    ...
    UndoableStringBuilder undoableStringBuilder = new UndoableStringBuilder();// expanded StringBuilder class with history of changes and last edited String
    List<ConcreteMember> members = new ArrayList<>();// list of members to notify
